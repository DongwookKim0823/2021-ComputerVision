...
void Prewitt_Y_Conv(BYTE* Img, BYTE* Out, int W, int H) // Prewitt ¸¶½ºÅ© Y
{
...
void Sobel_X_Conv(BYTE* Img, BYTE* Out, int W, int H) // Sobel ¸¶½ºÅ© X
{
	double Kernel[3][3] = { -1.0, 0.0, 1.0,
										-2.0, 0.0, 2.0,
										-1.0, 0.0, 1.0 };
...
void Sobel_Y_Conv(BYTE* Img, BYTE* Out, int W, int H) // Sobel ¸¶½ºÅ© Y
{
...
void Laplace_Conv(BYTE* Img, BYTE* Out, int W, int H) // Laplacian ¸¶½ºÅ©
{
	double Kernel[3][3] = { -1.0, -1.0, -1.0,
										-1.0, 8.0, -1.0,
										-1.0, -1.0, -1.0 };
...
void Laplace_Conv_DC(BYTE* Img, BYTE* Out, int W, int H) // (ÇÕÀÌ 1ÀÎ)Laplacian ¸¶½ºÅ©
{
	double Kernel[3][3] = { -1.0, -1.0, -1.0,
										-1.0, 9.0, -1.0,
										-1.0, -1.0, -1.0 };
